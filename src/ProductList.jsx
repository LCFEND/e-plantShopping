...
function ProductList() {
    ...
    const cart = useSelector(state => state.cart.items);
     ...
     // Monitor cart changes and update addedItems
     useEffect(() => {
        const cartItemNames = cart.map(item => item.name);
        setAddedItems(cartItemNames);
    }, [cart]);
            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" style={{ textDecoration: 'none' }}>
                            <div>
                                <h3 style={{ color: 'white' }}>Leea's Gardens</h3>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '1100px' }}>
                    ...
                    <a href="#" onClick={handleCartClick} style={{ color: 'white', fontSize: '30px', textDecoration: 'none' }}>
                        <h1 className='cart'>
                            <label style={{ zIndex: 1, position: 'fixed', right: '43px', top: '37px', fontSize: '25px', fontWeight: 'bold' }}>
                                {itemAmount()}
                            </label>
